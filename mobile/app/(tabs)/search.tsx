  ...
  return (
    <SafeAreaView className="flex-1" edges={['top', 'left', 'right']}>
      <View className='px-4 py-3'>
        <View className='flex-row bg-gray-200 items-center gap-3 rounded-full px-4 py-3'>
      ...
      >
        <Text className='text-xl font-bold mb-4'>Trending for you</Text>

        <View className="flex-col gap-3">
        {
          TRENDING_TOPICS.map(({ topic, tweets }, index) => <TouchableOpacity key={index}>
